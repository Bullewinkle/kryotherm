		...
		<div class="wr2">
			...
			<div class="center content">   <!-- колонка с содержимым -->
				...
				<div class="warning" style="font-size:16px; font-weight: bold;">
					Уважаемые покупатели обратите, пожалуйста, внимание, что заказы  будут обработаны не ранее 12.01.15. Не проводите электронные платежи во избежание недоразумений до указанной даты.
				</div>
				<br/>
