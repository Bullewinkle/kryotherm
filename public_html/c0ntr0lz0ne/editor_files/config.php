...
//
// Need help setting up this file? try pointing your web browser to [install location]editor_files/INSTALL_HELP.php
...
define('WP_WEB_DIRECTORY', '/c0ntr0lz0ne/editor_files/');
...
define('IMAGE_FILE_DIRECTORY', $_SERVER['DOCUMENT_ROOT'].'/');
...
define('DOCUMENT_FILE_DIRECTORY', $_SERVER['DOCUMENT_ROOT'].'/images/');
...
define('DOCUMENT_WEB_DIRECTORY', '/images/');
