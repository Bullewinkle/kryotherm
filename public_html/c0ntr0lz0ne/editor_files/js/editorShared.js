...
var wp_version="2.2.8"  // 2.2.12.1 -> 2.2.8
...
function wp_hide_error(evt) { // this project is getting so complex we need to block any errors that I may not have accounted for
  if (!wp_debug_mode) {
